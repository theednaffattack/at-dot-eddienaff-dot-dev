...
interface BookingsModalProps {
  ...
  bookingsModalState: ModalStates;
  setBookingsModalState: React.Dispatch<React.SetStateAction<ModalStates>>;
  teamId?: string;
  modalState: ModalStateInterface;
  modalDispatch: React.Dispatch<ModalViewActions>;
}

export const BookingsModal: React.FunctionComponent<BookingsModalProps> = ({
  bookingsModalState,
  setBookingsModalState,
  teamId,
  userInfo,
}) => {
  return (
    <>
      {bookingsModalState === "isOpen" ? (
          ...
          >
            <Card p={0} pb={3} width={1}>
              ...
              >
                ...
                <Button
                  type="button"
                  onClick={() => setBookingsModalState("isClosed")}
                >
                  Close
                </Button>
              </Flex>
