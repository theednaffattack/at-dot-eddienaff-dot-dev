...
type LabelRefType = HTMLLabelElement;

type SelectRefType = HTMLSelectElement;
type TextAreaRefType = HTMLTextAreaElement;
...
const getSystemProps = getProps((k: any) => PRE.test(k));
const getMarginProps = getProps((k: any) => MRE.test(k));
const omitMarginProps = getProps((k: any) => !MRE.test(k));
...
export const Textarea = forwardRef<TextAreaRefType, {}>((props, ref) => (
  <Box
    ref={ref}
    as="textarea"
    tx="forms"
...
const RadioChecked: React.FC<SxProps> = (props) => (
  <SVG {...props}>
    <path d="M12 7c-2.76 0-5 2.24-5 5s2.24 5 5 5 5-2.24 5-5-2.24-5-5-5zm0-5C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z" />
  </SVG>
);

const RadioUnchecked: React.FC<SxProps> = (props) => (
  <SVG {...props}>
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z" />
  </SVG>
);

const RadioIcon: React.FC<SxProps> = (props) => (
  <>
    <RadioChecked
      {...props}
      sx={{
...
export const Radio = forwardRef<InputRefType, RebassFormProps>(
...
export const Switch = forwardRef<ButtonRefType, RebassFormProps>(
  ({ checked, ...props }, ref) => (
    <Box
      ref={ref}
      as="button"
